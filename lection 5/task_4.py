...
def scrabble(word):
    """ Функция-помошник для игры "Эрудит".  На вход подаётся слово, на выходе количество очков из расчёта:
        (а, в, е=ё, и, н, о, р, с, т ) - 1 очко, (д, к, л, м, п, у) - 2 очка, (б, г, ь, я) - 3 очка,
        (й, ы) - 4 очка, (ж, з, х, ц, ч) - 5 очков, 6 и 7 очков не предусмотрено, (ф, ш, э, ю) - 8 очков,
        (щ) - 10 очков, (ъ) - 15 очков. """
